...
import IconFacebook from '@/svgs/Icon-Facebook.svg';
import Twitter from '@/svgs/Icon-Twitter.svg';
import Instagram from '@/svgs/icon-instagram.svg';
import Linkedin from '@/svgs/Icon-Linkedin.svg';
const Footer = () => {
  return (
    <footer className="xl:mt-[140px] lg:mt-[70px] md:mt-[50px] mt-[20px] bg-black break-words">
